...
vl_demo <- function() {
    ...
    raster_meta <- tribble(~name, ~citation, ~details,
                           ...
                           "GEBCO DEM", tags$span("GEBCO global bathymetry.", tags$a(href = "https://doi.org/10.5285/f98b053b-0cbc-6c23-e053-6c86abc0af7b", "https://doi.org/10.5285/f98b053b-0cbc-6c23-e053-6c86abc0af7b")), "A global DEM in COG format, on lat-long projection",
